    ...
    <div className="editor-panel">
      ...
      <select
        ...
        onChange={(e) =>
          setSettings((prev) => ({
            ...prev,
            button: { ...prev.button, shadow: e.target.value },
          }))
        }
      >
      ...
      <select
        ...
        onChange={(e) =>
          setSettings((prev) => ({
            ...prev,
            button: { ...prev.button, align: e.target.value },
          }))
        }
      >
      ...
      <input
        ...
        onChange={(e) =>
          setSettings((prev) => ({
            ...prev,
            layout: { ...prev.layout, sectionBg: e.target.value },
          }))
        }
      />
      ...
      <select
        ...
        onChange={(e) =>
          setSettings((prev) => ({
            ...prev,
            gallery: { ...prev.gallery, align: e.target.value },
          }))
        }
      >
